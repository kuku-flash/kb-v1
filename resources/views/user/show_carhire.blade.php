...
<section class="section bg-gray">
	...
	<div class="container">
        ...
        <a href="{{ route('user.index_carhire')}}" class="btn btn-primary">Back</a>
        <a href="{{ route('user.edit_carhire', [$listing->id, $vehicle->id])}}" class="btn btn-primary">Edit</a>
		<div class="row">
			<!-- Left sidebar -->
			<div class="col-md-8">
	...
	<!--		  <ul class="thumbs mt-3 slider-nav">
      ...
      <section class="vehicle specifications">
        <div class="widget disclaimer">
            <h5 class="widget-header">Hire this Car</h5>
            <div class="row">
            <div class="col-lg-6">Pickup Date: {{ $vehicle->pickup_date }}</div>
            <div class="col-lg-6">Return Date: {{ $vehicle->return_date }}</div>
            <div class="col-lg-6">Days {{ $vehicle->rent_days }}</div>
            <div class="col-lg-6"> <h5>Price per Day {{ $vehicle->price_per_day }}</h5></div>
			...
			<div class="col-md-4">
				<div class="sidebar">
					<div class="widget price mt-4 text-center">
						<h5>Price per Day   Kes{{ $vehicle->price_per_day }}</h5>
